...
class Parser {
   ...
   * For an 'include' statement, parsed data is all append to the given result parameter.
  ...
  private void includeFile(Result result, String dir, int num, String[] parsedKPF, boolean addAll) {
    ...
    String includeKPF = combine(keyword, project, file);
    ...
    String savedResultKey = combine(project, repoFile);
  ...
  static String combine(String project, String file) {
    return project + ":" + file;
  }

  // Build a readable key or output string for a (project, branch, file) tuple.
  static String combine(String project, String branch, String file) {
